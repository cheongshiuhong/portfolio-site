export const experiences = {
  ...
  'suss-teaching-assistant': {
    ...
    description : '',
    image: '/media/images/Singapore University of Social Sciences_Horizontal Format_Version A_White Background_RGB_72dpi.jpg',
    darkModeImage: '/media/images/H Format_Ver A_White on Black.jpg',
    startDate: 'Jul 2020',
    endDate: 'Present',
    skillsToShow: 3,
    skills: [
